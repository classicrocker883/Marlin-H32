...
CPP_SRCS += \
../Sources/Marlin/src/lcd/menu/game/brickout.cpp \
../Sources/Marlin/src/lcd/menu/game/game.cpp \
../Sources/Marlin/src/lcd/menu/game/invaders.cpp \
../Sources/Marlin/src/lcd/menu/game/maze.cpp \
../Sources/Marlin/src/lcd/menu/game/snake.cpp 

CPP_DEPS += \
./Sources/Marlin/src/lcd/menu/game/brickout.d \
./Sources/Marlin/src/lcd/menu/game/game.d \
./Sources/Marlin/src/lcd/menu/game/invaders.d \
./Sources/Marlin/src/lcd/menu/game/maze.d \
./Sources/Marlin/src/lcd/menu/game/snake.d 

OBJS += \
./Sources/Marlin/src/lcd/menu/game/brickout.o \
./Sources/Marlin/src/lcd/menu/game/game.o \
./Sources/Marlin/src/lcd/menu/game/invaders.o \
./Sources/Marlin/src/lcd/menu/game/maze.o \
./Sources/Marlin/src/lcd/menu/game/snake.o 


# Each subdirectory must supply rules for building sources it contributes
Sources/Marlin/src/lcd/menu/game/%.o: ../Sources/Marlin/src/lcd/menu/game/%.cpp Sources/Marlin/src/lcd/menu/game/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-Sources-2f-Marlin-2f-src-2f-lcd-2f-menu-2f-game

clean-Sources-2f-Marlin-2f-src-2f-lcd-2f-menu-2f-game:
	-$(RM) ./Sources/Marlin/src/lcd/menu/game/brickout.d ./Sources/Marlin/src/lcd/menu/game/brickout.o ./Sources/Marlin/src/lcd/menu/game/game.d ./Sources/Marlin/src/lcd/menu/game/game.o ./Sources/Marlin/src/lcd/menu/game/invaders.d ./Sources/Marlin/src/lcd/menu/game/invaders.o ./Sources/Marlin/src/lcd/menu/game/maze.d ./Sources/Marlin/src/lcd/menu/game/maze.o ./Sources/Marlin/src/lcd/menu/game/snake.d ./Sources/Marlin/src/lcd/menu/game/snake.o

.PHONY: clean-Sources-2f-Marlin-2f-src-2f-lcd-2f-menu-2f-game
